...
const files: readonly FileType[] = [
  { name: 'script.js', language: 'javascript', value: someJSCodeExample },
  { name: 'style.css', language: 'css', value: someCSSCodeExample },
  { name: 'index.html', language: 'html', value: someHTMLCodeExample },
];
